...
function Onboarding4(){
    return(
        <Fragment>
            <section
      class="before_login_page onboarding_page onboarding_page_4 remove_bg_image"
    >
      <div class="onboarding_div onboarding_div_2">
        <img src="assets/images/Logo.png" alt="" />
        <h4 class="common_head">Select your Avatar</h4>
        <div class="avtar_div">
          <img src="assets/images/Mask group.png" alt="" />
          <ol class="avtar_dots">
            <li class="active_avtar"></li>
            <li></li>
            <li></li>
            <li></li>
            <li></li>
          </ol>
          <span class="other_option_or">OR</span>
          <hr />

          <div class="upload_img_avtar">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
